(function () {
  ...
  function render(places) {
    ...
    var toShow = places.slice(0, MAX_TRAVELS_SHOWN);

    if (toShow.length === 0) {
      var msg = (window.i18n && window.i18n.t('mainPage.noTravelsYet')) ||
        'No travels yet. <a href="visitedPlaces/add_new_place.html">Add your first place</a>.';
    ...
    container.innerHTML = toShow.map(renderLogCard).join('');
