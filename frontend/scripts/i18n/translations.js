window.I18N_TRANSLATIONS = {
  en: {
    ...
    admin: {
      ...
      feedbackHint: 'Messages submitted by users from their profile page.',
  ...
  hu: {
    ...
    admin: {
      ...
      feedbackHint: 'A felhasználók profiloldaláról érkező üzenetek.',
  ...
  de: {
    ...
    admin: {
      ...
      serverError: 'Serverfehler. Bitte versuche es später erneut.',
      feedbackSection: 'Feedback',
      feedbackHint: 'Nachrichten, die Nutzer über ihre Profilseite gesendet haben.',
