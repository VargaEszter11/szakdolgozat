window.I18N_TRANSLATIONS = {
  en: {
    ...
    visitedPlaces: {
      ...
      addPhotosHint:
        'Add photos by clicking or dragging and dropping (PNG or JPG, max 10 MB each). You can select several at once or add more in another step.',
    ...
    addNewPlace: {
      ...
      photosPlaceholder: 'Click to upload photos, or drag and drop',
    ...
    planNewTrip: {
      ...
      updateHomeCity: 'Update home city',
      homeCityCurrent: 'Saved home city: {{city}}',
      homeCitySaved: 'Home city updated.',
      homeCityRequired: 'Type a starting city first, then save it as your home city.',
      ...
      noPlanReasonVisitedNoMatch: 'None of the requested places could be reached with a direct route or booked flight from your starting city.',
      noPlanReasonNoDestinations: 'No direct routes are available from your starting city with the current filters.',
      noPlanReasonTransportRestrictive: 'No destinations match the selected transport mode from your starting city. Try allowing more transport modes.',
      noPlanReasonNoAvailability: 'No bookable flights or ground routes were found for the selected start date.',
      noPlanReasonBookingFailed: 'A route was found, but booking details could not be confirmed for it.',
      ...
      startDateNotInPast: 'Start date cannot be before today.',
      ...
      errorServiceUnavailable: 'The trip-planning service is temporarily unavailable or took too long to respond. Please try again in a few minutes.',
      errorRateLimited: 'Too many requests right now. Please wait a moment and try again.',
      errorServerGeneric: 'An unexpected server error occurred while generating the plan.',
      errorGeneric: 'The server responded with an unexpected error.',
    ...
    plannedTrips: {
      ...
      shareAcceptError: 'Could not accept the invitation.',
      shareDeclineError: 'Could not decline the invitation.',
      ...
      editFieldPeople: 'Travellers',
      editPeopleInvalid: 'Travellers must be at least 1.',
      ...
      editDragHandle: 'Drag to reorder',
    ...
    profile: {
      ...
      feedbackImagePlaceholder: 'Click to upload a photo, or drag and drop',
      ...
      feedbackHistoryTitle: 'Your feedback',
      feedbackHistoryLoading: 'Loading…',
      feedbackHistoryEmpty: 'You have not sent feedback yet.',
      feedbackHistoryFailed: 'Could not load your feedback.',
      feedbackHistoryMore: 'More',
      feedbackHistoryLess: 'Show less',
      feedbackStatusPending: 'Pending',
      feedbackStatusSolved: 'Solved',
      feedbackDetailTitle: 'Feedback details',
      feedbackDetailClose: 'Close',
      feedbackHasImage: 'Has image',
    },
    notifications: {
      title: 'Notifications',
      ...
      shareDeclinedTitle: 'Shared trip declined',
      shareDeclinedBody: '{{user}} declined your shared trip “{{trip}}”.',
      feedbackSolvedTitle: 'Feedback marked as solved',
      tripCompletedTitle: 'Trip completed',
      tripCompletedBody: '“{{trip}}” ended on {{date}}.',
      plannerReadyTitle: 'Your trip plan is ready',
      plannerReadyBody: 'Open “{{trip}}” to review and save.',
      plannerReadyBodyGeneric: 'Open the planner to review and save it.',
    },
    editProfile: {
      title: 'Edit profile',
      ...
      passwordEmailSent: 'If an account exists for this email, we sent a password reset link. Check your inbox.',
      passwordEmailFailed: 'Could not send the password reset email. Check email settings or try again later.',
      passwordResetNeedsEmail: 'Save a valid email on your profile first.',
    ...
    verifyEmail: {
      ...
      pageTitle: 'Confirm email – Planventure',
      subtitle: 'Finish creating your account',
      pending: 'Confirming your email…',
      successMessage: 'Your email is confirmed. You can log in now.',
      invalidLinkMessage: 'This confirmation link is invalid or has expired. Register again or request a new link.',
    ...
    resetPassword: {
      ...
      newPasswordPlaceholder: 'Min. 8 chars, upper, lower, number, special',
    ...
    admin: {
      ...
      serverError: 'Server error. Please try again later.',
      scrapeSection: '3. Refresh airline routes',
      scrapeHint: 'Re-fetches direct routes for Ryanair, Lufthansa, KLM and Wizz Air. Routes an airline no longer flies are marked inactive.',
      scrapeButton: 'Run airline scrapers',
      scrapeRunning: 'Running scrapers…',
      scrapeStarted: 'Airline scrapers started. This can take a minute…',
      scrapeComplete: 'Airline scrape complete:',
      scrapeCompleteWithErrors: 'Airline scrape finished with errors:',
      scrapeAirlineFailed: 'failed',
      scrapeFailed: 'Could not run airline scrapers.',
      ...
      feedbackMarkSolved: 'Mark solved',
      feedbackMarkOpen: 'Mark open',
      feedbackMarkedSolved: 'Feedback marked as solved.',
      feedbackReopened: 'Feedback marked as open.',
      feedbackSolveFailed: 'Could not update feedback.',
  ...
  hu: {
    ...
    visitedPlaces: {
      ...
      addPhotosHint:
        'Fényképek hozzáadása kattintással vagy ide húzással (PNG vagy JPG, max. 10 MB darabonként). Egyszerre többet is kiválaszthatsz, vagy később újabbakat adhatsz hozzá.',
    ...
    addNewPlace: {
      ...
      photosPlaceholder: 'Kattints vagy húzd ide a fényképeket a feltöltéshez',
    ...
    planNewTrip: {
      ...
      updateHomeCity: 'Otthoni város frissítése',
      homeCityCurrent: 'Mentett otthoni város: {{city}}',
      homeCitySaved: 'Otthoni város frissítve.',
      homeCityRequired: 'Először írj be egy kiindulási várost, majd mentsd el otthoni városként.',
      ...
      noPlanReasonVisitedNoMatch: 'A kért helyek egyikét sem sikerült elérni közvetlen útvonallal vagy foglalható járattal a kiindulási városból.',
      noPlanReasonNoDestinations: 'Nincs elérhető közvetlen útvonal a kiindulási városból a jelenlegi szűrőkkel.',
      noPlanReasonTransportRestrictive: 'Nincs a kiválasztott közlekedési módnak megfelelő úticél a kiindulási városból. Próbálj meg több közlekedési módot engedélyezni.',
      noPlanReasonNoAvailability: 'Nem található foglalható járat vagy földi útvonal a megadott kezdő dátumra.',
      noPlanReasonBookingFailed: 'Talált a rendszer útvonalat, de a foglalási adatokat nem sikerült megerősíteni hozzá.',
      ...
      startDateNotInPast: 'A kezdő dátum nem lehet korábbi a mai napnál.',
      ...
      errorServiceUnavailable: 'Az útiterv-készítő szolgáltatás átmenetileg nem elérhető, vagy túl sokáig tartott a válasz. Próbáld újra néhány perc múlva.',
      errorRateLimited: 'Túl sok kérés érkezett rövid idő alatt. Kérjük, várj egy kicsit, majd próbáld újra.',
      errorServerGeneric: 'Váratlan szerverhiba történt az útiterv generálása közben.',
      errorGeneric: 'A szerver váratlan hibával válaszolt.',
    ...
    plannedTrips: {
      ...
      shareInboxTitle: 'Veled megosztva',
      ...
      shareAcceptError: 'A meghívó elfogadása sikertelen.',
      shareDeclineError: 'A meghívó elutasítása sikertelen.',
      ...
      editFieldPeople: 'Utasok',
      editPeopleInvalid: 'Legalább 1 utas kell.',
      ...
      editDragHandle: 'Húzd az átrendezéshez',
    ...
    profile: {
      ...
      feedbackImagePlaceholder: 'Kattints vagy húzd ide a képet a feltöltéshez',
      ...
      feedbackHistoryTitle: 'Saját visszajelzéseid',
      feedbackHistoryLoading: 'Betöltés…',
      feedbackHistoryEmpty: 'Még nem küldtél visszajelzést.',
      feedbackHistoryFailed: 'Nem sikerült betölteni a visszajelzéseket.',
      feedbackHistoryMore: 'Több',
      feedbackHistoryLess: 'Kevesebb',
      feedbackStatusPending: 'Folyamatban',
    ...
    notifications: {
      ...
      shareDeclinedTitle: 'Megosztott utazás elutasítva',
      shareDeclinedBody: '{{user}} elutasította a megosztott utazásod: „{{trip}}”.',
      feedbackSolvedTitle: 'Visszajelzés megoldva',
      tripCompletedTitle: 'Utazás lezárult',
      tripCompletedBody: '„{{trip}}” vége: {{date}}.',
      plannerReadyTitle: 'Az utazásterved kész',
      plannerReadyBody: 'Nyisd meg: „{{trip}}” — átnézés és mentés.',
      plannerReadyBodyGeneric: 'Nyisd meg a tervezőt az átnézéshez és mentéshez.',
    },
    editProfile: {
      ...
      passwordEmailSent: 'Ha létezik fiók ezzel az e-mail címmel, elküldtük a jelszó-visszaállító linket. Nézd meg a postafiókod.',
      passwordEmailFailed: 'Nem sikerült elküldeni a jelszó-visszaállító e-mailt. Ellenőrizd az e-mail beállításokat, vagy próbáld később.',
      passwordResetNeedsEmail: 'Először ments egy érvényes e-mail címet a profilodra.',
      errorLoad: 'A profil betöltése sikertelen.',
    ...
    register: {
      ...
      passwordPlaceholder: 'Min. 8 karakter, nagy/kisbetű, szám, speciális',
    ...
    verifyEmail: {
      ...
      pageTitle: 'E-mail megerősítése – Planventure',
      subtitle: 'Fejezd be a fiók létrehozását',
      pending: 'E-mail megerősítése…',
      successMessage: 'Az e-mail címed megerősítve. Most már bejelentkezhetsz.',
      invalidLinkMessage: 'Ez a megerősítő link érvénytelen vagy lejárt. Regisztrálj újra, vagy kérj új linket.',
    ...
    resetPassword: {
      ...
      newPasswordPlaceholder: 'Min. 8 karakter, nagy/kisbetű, szám, speciális',
    ...
    admin: {
      ...
      serverError: 'Szerverhiba történt. Kérjük, próbáld újra később.',
      scrapeSection: '3. Légitársaság-járatok frissítése',
      scrapeHint: 'Újra lekéri a Ryanair, Lufthansa, KLM és Wizz Air közvetlen járatait. Azok a járatok, amelyeket a légitársaság már nem üzemeltet, inaktívvá válnak.',
      scrapeButton: 'Scraperek futtatása',
      scrapeRunning: 'Scraperek futnak…',
      scrapeStarted: 'A scraperek elindultak. Ez eltarthat egy percig…',
      scrapeComplete: 'A légitársaság-adatok frissítése kész:',
      scrapeCompleteWithErrors: 'A frissítés hibákkal fejeződött be:',
      scrapeAirlineFailed: 'sikertelen',
      scrapeFailed: 'Nem sikerült futtatni a scrapereket.',
      ...
      feedbackStatusSolved: 'Megoldva',
      feedbackStatusOpen: 'Nyitott',
      feedbackMarkSolved: 'Megoldottnak jelöl',
      feedbackMarkOpen: 'Újranyitás',
      feedbackMarkedSolved: 'Visszajelzés megoldottnak jelölve.',
      feedbackReopened: 'Visszajelzés újranyitva.',
      feedbackSolveFailed: 'Nem sikerült frissíteni.',
  ...
  de: {
    ...
    visitedPlaces: {
      ...
      addPhotosHint:
        'Fotos per Klick oder Ziehen hinzufügen (PNG oder JPG, max. 10 MB pro Datei). Mehrere Dateien auf einmal oder später weitere auswählen.',
    ...
    addNewPlace: {
      ...
      photosPlaceholder: 'Klicken oder Fotos hierher ziehen',
    ...
    planNewTrip: {
      ...
      updateHomeCity: 'Heimatstadt aktualisieren',
      homeCityCurrent: 'Gespeicherte Heimatstadt: {{city}}',
      homeCitySaved: 'Heimatstadt aktualisiert.',
      homeCityRequired: 'Gib zuerst eine Startstadt ein und speichere sie dann als Heimatstadt.',
      ...
      noPlanReasonVisitedNoMatch: 'Keiner der gewünschten Orte konnte mit einer Direktroute oder einem buchbaren Flug von deiner Startstadt aus erreicht werden.',
      noPlanReasonNoDestinations: 'Von deiner Startstadt aus sind mit den aktuellen Filtern keine Direktrouten verfügbar.',
      noPlanReasonTransportRestrictive: 'Kein Reiseziel passt von deiner Startstadt aus zum gewählten Verkehrsmittel. Versuche, weitere Verkehrsmittel zuzulassen.',
      noPlanReasonNoAvailability: 'Für das gewählte Startdatum wurden keine buchbaren Flüge oder Landrouten gefunden.',
      noPlanReasonBookingFailed: 'Es wurde eine Route gefunden, die Buchungsdetails dafür konnten jedoch nicht bestätigt werden.',
      ...
      startDateNotInPast: 'Das Startdatum darf nicht vor heute liegen.',
      ...
      errorServiceUnavailable: 'Der Reiseplanungsdienst ist vorübergehend nicht verfügbar oder hat zu lange für eine Antwort gebraucht. Bitte versuche es in ein paar Minuten erneut.',
      errorRateLimited: 'Gerade kamen zu viele Anfragen. Bitte warte einen Moment und versuche es erneut.',
      errorServerGeneric: 'Beim Generieren des Plans ist ein unerwarteter Serverfehler aufgetreten.',
      errorGeneric: 'Der Server hat mit einem unerwarteten Fehler geantwortet.',
    ...
    plannedTrips: {
      ...
      shareAcceptError: 'Die Einladung konnte nicht angenommen werden.',
      shareDeclineError: 'Die Einladung konnte nicht abgelehnt werden.',
      ...
      editFieldPeople: 'Reisende',
      editPeopleInvalid: 'Es muss mindestens 1 Reisender sein.',
      ...
      editDragHandle: 'Zum Umsortieren ziehen',
    ...
    profile: {
      ...
      feedbackImagePlaceholder: 'Klicke oder ziehe ein Foto hierher',
      ...
      feedbackHistoryTitle: 'Dein Feedback',
      feedbackHistoryLoading: 'Laden…',
      feedbackHistoryEmpty: 'Du hast noch kein Feedback gesendet.',
      feedbackHistoryFailed: 'Feedback konnte nicht geladen werden.',
      feedbackHistoryMore: 'Mehr',
      feedbackHistoryLess: 'Weniger',
      feedbackStatusPending: 'Offen',
      feedbackStatusSolved: 'Erledigt',
      feedbackDetailTitle: 'Feedback-Details',
      feedbackDetailClose: 'Schließen',
      feedbackHasImage: 'Mit Bild',
    },
    notifications: {
      ...
      shareDeclinedTitle: 'Geteilte Reise abgelehnt',
      shareDeclinedBody: '{{user}} hat deine geteilte Reise „{{trip}}” abgelehnt.',
      ...
      plannerReadyTitle: 'Dein Reiseplan ist fertig',
      plannerReadyBody: 'Öffne „{{trip}}”, um ihn zu prüfen und zu speichern.',
      plannerReadyBodyGeneric: 'Öffne den Planer zum Prüfen und Speichern.',
    },
    editProfile: {
      ...
      passwordEmailSent: 'Falls ein Konto mit dieser E-Mail existiert, haben wir einen Link zum Zurücksetzen des Passworts gesendet. Prüfe deinen Posteingang.',
      passwordEmailFailed: 'E-Mail zum Zurücksetzen des Passworts konnte nicht gesendet werden. Prüfe die E-Mail-Einstellungen oder versuche es später erneut.',
      passwordResetNeedsEmail: 'Speichere zuerst eine gültige E-Mail in deinem Profil.',
      errorLoad: 'Profil konnte nicht geladen werden.',
    ...
    register: {
      ...
      passwordPlaceholder: 'Min. 8 Zeichen, Groß/Klein, Zahl, Sonderzeichen',
    ...
    verifyEmail: {
      ...
      pageTitle: 'E-Mail bestätigen – Planventure',
      subtitle: 'Schließe die Kontoerstellung ab',
      pending: 'E-Mail wird bestätigt…',
      successMessage: 'Deine E-Mail wurde bestätigt. Du kannst dich jetzt anmelden.',
      invalidLinkMessage: 'Dieser Bestätigungslink ist ungültig oder abgelaufen. Registriere dich erneut oder fordere einen neuen Link an.',
    ...
    resetPassword: {
      ...
      newPasswordPlaceholder: 'Min. 8 Zeichen, Groß/Klein, Zahl, Sonderzeichen',
    ...
    admin: {
      ...
      serverError: 'Serverfehler. Bitte versuche es später erneut.',
      scrapeSection: '3. Fluggesellschaft-Routen aktualisieren',
      scrapeHint: 'Ruft die Direktflüge von Ryanair, Lufthansa, KLM und Wizz Air erneut ab. Routen, die eine Fluggesellschaft nicht mehr bedient, werden deaktiviert.',
      scrapeButton: 'Scraper ausführen',
      scrapeRunning: 'Scraper laufen…',
      scrapeStarted: 'Die Fluggesellschaft-Scraper wurden gestartet. Dies kann eine Minute dauern…',
      scrapeComplete: 'Aktualisierung der Fluggesellschaften abgeschlossen:',
      scrapeCompleteWithErrors: 'Aktualisierung mit Fehlern abgeschlossen:',
      scrapeAirlineFailed: 'fehlgeschlagen',
      scrapeFailed: 'Die Scraper konnten nicht ausgeführt werden.',
      ...
      feedbackStatusSolved: 'Erledigt',
      feedbackStatusOpen: 'Offen',
      feedbackMarkSolved: 'Als erledigt markieren',
      feedbackMarkOpen: 'Wieder öffnen',
      feedbackMarkedSolved: 'Feedback als erledigt markiert.',
      feedbackReopened: 'Feedback wieder geöffnet.',
      feedbackSolveFailed: 'Feedback konnte nicht aktualisiert werden.',
