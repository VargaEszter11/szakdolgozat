window.I18N_TRANSLATIONS = {
  en: {
    ...
    addNewPlace: {
      ...
      photosPlaceholder: 'Click to upload a photo',
      photosHint: 'One PNG or JPG, max 10 MB',
      add: 'Add Place',
      cancel: 'Cancel',
  ...
  hu: {
    ...
    addNewPlace: {
      ...
      photosPlaceholder: 'Kattints egy fénykép feltöltéséhez',
      photosHint: 'Egy PNG vagy JPG, legfeljebb 10 MB',
      add: 'Hely hozzáadása',
      cancel: 'Mégse',
  ...
  de: {
    ...
    addNewPlace: {
      ...
      photosPlaceholder: 'Klicken, um ein Foto hochzuladen',
      photosHint: 'Ein PNG oder JPG, max. 10 MB',
      add: 'Ort hinzufügen',
      cancel: 'Abbrechen',
