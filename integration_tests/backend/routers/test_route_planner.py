...
class TestTravelPlanGeneration:
    ...
    def test_generate_visited_plan(self, mock_generate, client, test_user):
    ...
    def test_generate_unvisited_plan(self, mock_generate, client, test_user):
    ...
    def test_generate_random_plan(self, mock_generate, client):
