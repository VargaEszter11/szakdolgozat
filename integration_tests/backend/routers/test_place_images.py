...
class TestPlaceImages:
    ...
    def test_create_place_image(self, client, visited_place):
    ...
    def test_create_place_image_place_not_found(self, client):
        response = client.post(
    ...
    def test_upload_place_image(self, client, visited_place):
        png_bytes = (
    ...
    def test_upload_place_image_invalid_type(self, client, visited_place):
        response = client.post(
            f"/api/visited-places/{visited_place['id']}/images/upload",
    ...
    def test_list_place_images(self, client, visited_place):
        client.post(
            f"/api/visited-places/{visited_place['id']}/images",
        ...
        response = client.get(f"/api/visited-places/{visited_place['id']}/images")

        assert response.status_code == 200
        images = response.json()
        assert len(images) == 2

    def test_list_place_images_place_not_found(self, client):
        response = client.get("/api/visited-places/9999/images")

        assert response.status_code == 404

    def test_get_image_by_id(self, client, visited_place):
    ...
    def test_update_image(self, client, visited_place):
        create_response = client.post(
            f"/api/visited-places/{visited_place['id']}/images",
    ...
    def test_delete_image(self, client, visited_place):
        create_response = client.post(
            f"/api/visited-places/{visited_place['id']}/images",
    ...
    def test_delete_image_not_found(self, client):
        response = client.delete("/api/images/9999")
